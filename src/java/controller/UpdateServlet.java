    ...
    throws ServletException, IOException {
       ...
       String url = request.getContextPath() + "/admin";
        String album_ID = request.getParameter("id");
         Integer id = Integer.valueOf(album_ID);

        AlbumDAO ad = new AlbumDAO();
        Album a = ad.getAlbumByID(id);
        String edit_name =request.getParameter("edit_name");
        a.setName(edit_name);
        String edit_author = request.getParameter("edit_author");
        a.setAuthor(edit_author);
       String categoryParam = request.getParameter("edit_category");
       int category_ID = Integer.valueOf(categoryParam);
